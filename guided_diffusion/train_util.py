...
class TrainLoop:
    ...
    def run_loop(self):
        ...
        while (
            ...
            try:
                    batch, cond, name, text_label = next(data_iter)
            ...
            self.run_step(batch, cond, text_label)
    ...
    def run_step(self, batch, cond, text_list):
        batch=th.cat((batch, cond), dim=1)

        cond={}
        sample = self.forward_backward(batch, cond, text_list)
    ...
    def forward_backward(self, batch, cond, text_list):
