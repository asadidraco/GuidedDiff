...
class GaussianDiffusion:
    ...
    def p_mean_variance(
        self, model, x, t, text, clip_denoised=True, denoised_fn=None, model_kwargs=None
    ):
        """
        ...
        # print(model)
        # print("------------------------------+++++++++++++++++++++++++--------")
        model_output = model(x, text, self._scale_timesteps(t), **model_kwargs)
        # print("[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]]")
        ...
        if progress:
           ...
           for i in indices:
                ...
                with th.no_grad():
                    ...
                    #plt.imsave(f'org_MRI_{i}.png', org_MRI[0].permute(1,2,0).cpu().numpy())
                    # print("******************img bef size***************************")
                    if img.size(1) != org_c:
    ...
    def ddim_sample_loop_known(
        ...
        for sample in self.ddim_sample_loop_progressive(
            ...
            final = sample
        print("++++++++++++++++++++++++++++++++++++++ddim_sample_loop_known is running++++++++++++++++++++++++++++++++++++++++++")
    ...
    def _vb_terms_bpd(
        self, model, x_start, x_t, t, text, clip_denoised=True, model_kwargs=None
    ):
        """
        ...
        out = self.p_mean_variance(
            model, x_t, t, text, clip_denoised=clip_denoised, model_kwargs=model_kwargs
        )
        kl = normal_kl(
    ...
    def training_losses_segmentation(self, model, classifier, x_start, t, text, model_kwargs=None, noise=None):
        """
        ...
        if self.loss_type == LossType.MSE or self.loss_type == LossType.BCE_DICE or self.loss_type == LossType.RESCALED_MSE:
            model_output, cal = model(x_t, text, self._scale_timesteps(t), **model_kwargs)
