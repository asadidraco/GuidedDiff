...
def main():
    ...
    state_dict = dist_util.load_state_dict(args.model_path, map_location=torch.device('cuda'))
    ...
    for ind in range(len(data)):
        ...
        b, m, path, text_list = next(data)  #should return an image from the dataloader "data"
        c = th.randn_like(b[:, :1, ...])
...
def create_argparser():
    defaults = dict(
        ...
        batch_size=1,
        use_ddim=False,
        model_path="./results/savedmodel100000.pt",         #path to pretrain model
